...
%
  ...
  \]
\item This exercise leaves a lot open for modeling. Here are two
  suggestions. We are assuming a pitch which is a one-dimensional
...
%
  We will first put the center of the pitch on the $0$ coordinate,
  and the two goals on some coordinates $\mathit{goal}$ and
